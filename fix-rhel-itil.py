...
@media (max-width: 768px) {
  ...
  code { font-size: .68rem !important; }

  /* ── Tables ───────────────────────────────────────────── */
  table {
    display: block !important; overflow-x: auto !important;
    -webkit-overflow-scrolling: touch !important; font-size: .78rem !important;
  }
  th { white-space: nowrap !important; }
  ...
  .itil-sec {
    padding: 10px 16px 3px !important; font-size: 8px !important;
